module.exports = {
  ...
  urlForBild: 'https://bild-vs-h7f93kf62lk1.json.c.ergebnis-dienst.de/',
  localTimeRange: {
    from: '08:00:00',
    to: '01:00:00'
  },
  ...
  data: {
    ...
    matchDetails: {
      identifier: 'match-detail',
      label: 'Informationen zum Spiel',
      url: 'match/ma[[MATCHID]]',
    },
    personStatsByMatch: {
      identifier: 'person-stats-by-match',
      label: 'Informationen zum Spiel',
      url: 'person-stats-by-match/ma[[MATCHID]]',
    },
    positionValues: {
      identifier: 'position-values',
