module.exports = {
  uuid: '0',
  template_name: 'of_goals_over_season',
  name: 'Goals over season',
  data: {
    dynamic: {
      assets: {},
      matchInfo: {
      ...
      goalData: [
        { range: '0-15', teamA: 4, teamB: 3 },
        { range: '15-30', teamA: 2, teamB: 7 },
        { range: '30-45', teamA: 3, teamB: 4 },
        { range: '45-60', teamA: 2, teamB: 4 },
        { range: '60-75', teamA: 3, teamB: 4 },
        { range: '75-96', teamA: 7, teamB: 8 }
      ]
    },
    fields: [],
    options: [
