module.exports = {
  uuid: '0',
  template_name: 'bild_playercompare_season',
  name: 'Player Compare Season',
  data: {
    dynamic: {
      matchInfo: {
      ...
      playerCompare: {
        home: {
          position: 'Forward',
          id: '3jqxaa2l6gqwxl2mr8w0yiiy2',
          shirtNumber: '34',
          firstName: 'Nathanaël',
          lastName: 'Mbuku',
          shortFirstName: 'Nathanaël',
          shortLastName: 'Mbuku',
          matchName: 'N. Mbuku',
          stat: [
            {
            ...
            {
              name: 'Total Touches In Opposition Box',
              value: '1'
            },
            {
