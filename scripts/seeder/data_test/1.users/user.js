...
module.exports = [
  {
    _id: new ObjectId("5aa1c2c35ef7a4e97b5e0001"),
  ...
  {
    _id: new ObjectId("5aa1c2c35ef7a4e97b5e0002"),
    name: 'Simple user',
    email: 'user@user.com',
    password: '$2a$05$2KOSBnbb0r.0TmMrvefbluTOB735rF/KRZb4pmda4PdvU9iDvUB26',
    role: 'user',
  ...
  {
    _id: new ObjectId("5aa1c2c35ef7a4e97b5e0003"),
    name: 'Simple user 2',
  ...
  {
    _id: new ObjectId("1aa1c2c35ef7a4e97b5e0003"),
    name: 'Simple user 3',
    email: 'alreadyexist@user.com',
    password: '$2a$05$2KOSBnbb0r.0TmMrvefbluTOB735rF/KRZb4pmda4PdvU9iDvUB26',
    role: 'user',
    verified: true,
    verification: '3d6e072c-0eaf-4239-bb5e-495e6486148d',
